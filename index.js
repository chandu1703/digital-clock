...
"Good Morning!!!!! lets have breakfast"    }

    if (lunchtime == hours) {
      document.getElementById("food_image").style.backgroundImage =
        "url('./images/lunchImage.png')";
      document.getElementById("food_msg").innerHTML = "Good Afternoon !!!! Let's have lunch";
    }
    if (naptime == hours) {
      document.getElementById("food_image").style.backgroundImage =
        "url('./images/sleepScore.png')";
      document.getElementById("food_msg").innerHTML =
        "Good Evening Let's have some dinner and have a nap";
    }
  ...
  function displayValue() {
    ...
    if (waketime == "none") {
      ...
      document.getElementById("wake_up").innerHTML ="Good morning Buddy "
